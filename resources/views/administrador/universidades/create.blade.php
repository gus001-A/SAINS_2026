...
@section('title', 'Nueva Universidad - SAINS')
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h1 class="display-5 fw-bold" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); -webkit-background-clip: text; background-clip: text; color: transparent;">
                    <i class="fas fa-university me-3"></i>Nueva Universidad
                </h1>
                <p class="text-muted">Registre una nueva universidad de interés para los estudiantes</p>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card-modern p-4 p-lg-5">
            <form action="{{ route('admin.universidades.store') }}" method="POST" id="universidadForm" novalidate>
                @csrf
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" name="clave" id="clave" 
                                       ...
                                       value="{{ old('clave') }}" placeholder="Ej: UNAM, UAEM, IPN, BUAP" required>
                            </div>
                            @error('clave')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="tipo" id="tipo" class="form-select form-select-lg">
                                ...
                                <option value="AUTONOMA" {{ old('tipo') == 'AUTONOMA' ? 'selected' : '' }}>AUTÓNOMA</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="duracion" id="duracion" class="form-select form-select-lg">
                                ...
                                <option value="4 AÑOS" {{ old('duracion') == '4 AÑOS' ? 'selected' : '' }}>4 AÑOS (Licenciatura)</option>
                                <option value="5 AÑOS" {{ old('duracion') == '5 AÑOS' ? 'selected' : '' }}>5 AÑOS (Ingeniería)</option>
                                <option value="3 AÑOS" {{ old('duracion') == '3 AÑOS' ? 'selected' : '' }}>3 AÑOS (TSU)</option>
                            </select>
