...
@section('title', 'Editar Pregunta - SAINS')
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h1 class="display-5 fw-bold" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); -webkit-background-clip: text; background-clip: text; color: transparent;">
                    <i class="fas fa-edit me-3"></i>Editar Pregunta
                </h1>
                <p class="text-muted">Modifique la información de la pregunta</p>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card-modern p-4 p-lg-5">
            <form action="{{ route('admin.preguntas.update', $pregunta->id) }}" method="POST" id="preguntaForm" novalidate>
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <select name="id_area" id="id_area" class="form-select form-select-lg @error('id_area') is-invalid @enderror" required>
                                ...
                                @foreach($areas as $area)
                                    <option value="{{ $area->id }}" {{ old('id_area', $pregunta->id_area) == $area->id ? 'selected' : '' }}>{{ $area->nombre }}</option>
                                @endforeach
                            </select>
                            @error('id_area')
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="pregunta" id="pregunta" class="form-control form-control-lg @error('pregunta') is-invalid @enderror" 
                                      rows="5" placeholder="Escriba la pregunta aquí..." required>{{ old('pregunta', $pregunta->pregunta) }}</textarea>
                            @error('pregunta')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" name="respuesta_correcta" id="respuesta_correcta" 
                                       ...
                                       value="{{ old('respuesta_correcta', $pregunta->respuesta_correcta) }}" placeholder="Ej: 42" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" name="respuesta1" id="respuesta1" 
                                       ...
                                       value="{{ old('respuesta1', $pregunta->respuesta1) }}" placeholder="Ej: 41">
                            </div>
                            @error('respuesta1')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" name="respuesta2" id="respuesta2" 
                                       ...
                                       value="{{ old('respuesta2', $pregunta->respuesta2) }}" placeholder="Ej: 43">
                            </div>
                            @error('respuesta2')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="d-flex justify-content-between gap-3 mt-5 pt-4 border-top">
                    ...
                    <button type="submit" class="btn btn-update px-5 py-3" id="submitBtn" style="display: none;">
                        <i class="fas fa-save me-2"></i> Actualizar Pregunta
                    </button>
