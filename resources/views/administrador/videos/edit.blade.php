...
@section('title', 'Editar Video - SAINS')
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h1 class="display-5 fw-bold" style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); -webkit-background-clip: text; background-clip: text; color: transparent;">
                    <i class="fas fa-edit me-3"></i>Editar Video
                </h1>
                <p class="text-muted">Modifique la información del video educativo</p>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card-modern p-4 p-lg-5">
            <form action="{{ route('admin.videos.update', $video->id) }}" method="POST" id="videoForm" novalidate>
                @csrf
                @method('PUT')
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <select name="materia" id="materia" class="form-select @error('materia') is-invalid @enderror" required>
                                    ...
                                    @foreach($asignaturas as $asignatura)
                                        <option value="{{ $asignatura->nombre }}" {{ old('materia', $video->materia) == $asignatura->nombre ? 'selected' : '' }}>
                                            {{ $asignatura->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" name="tema" id="tema" 
                                       ...
                                       value="{{ old('tema', $video->tema) }}" placeholder="Ej: Álgebra, Gramática..." required>
                            </div>
                            @error('tema')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" name="titulo" id="titulo" 
                                       ...
                                       value="{{ old('titulo', $video->titulo) }}" placeholder="Título descriptivo del video" required>
                            </div>
                            @error('titulo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="platform" id="platformYoutube" value="youtube">
                        ...
                        <div class="col-12" id="youtubeInput">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="url" name="link" id="youtubeUrl" 
                                       ...
                                       value="{{ old('link', $video->link) }}" placeholder="https://www.youtube.com/watch?v=XXXXXXXXXXX">
                            </div>
                            @error('link')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" name="duracion" id="duracion" 
                                       ...
                                       value="{{ old('duracion', $video->duracion) }}" placeholder="MM:SS o HH:MM:SS">
                            </div>
                            @error('duracion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-switch mt-2">
                                <input type="checkbox" class="form-check-input" id="plan" name="plan" value="1" 
                                       style="width: 4em; height: 2em; cursor: pointer;" {{ old('plan', $video->plan) ? 'checked' : '' }}>
...
<script>
    ...
    // Detectar plataforma desde la URL existente
    ...
    // Extraer ID de Vimeo si es necesario
    ...
    if (platform === 'vimeo') {
        platformVimeo.checked = true;
        youtubeInput.style.display = 'none';
        vimeoInput.style.display = 'block';
        const vimeoIdValue = extractVimeoId(currentUrl);
        if (vimeoIdValue) {
            vimeoId.value = vimeoIdValue;
        }
        youtubeUrl.required = false;
        vimeoId.required = true;
    } else {
        platformYoutube.checked = true;
    ...
    // Detectar si hay errores de validación para mostrar el paso correspondiente
    @if($errors->any())
        @if($errors->has('materia') || $errors->has('tema') || $errors->has('titulo'))
            mostrarPaso(1);
            currentStep = 1;
        @elseif($errors->has('link'))
            mostrarPaso(2);
            currentStep = 2;
        @elseif($errors->has('duracion') || $errors->has('plan'))
            mostrarPaso(3);
            currentStep = 3;
        @endif
    @endif
