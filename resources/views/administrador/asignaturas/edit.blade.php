                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <div>
                        <h1 class="display-5 fw-bold" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); -webkit-background-clip: text; background-clip: text; color: transparent;">
                            <i class="fas fa-edit me-3"></i>Editar Materia
                        </h1>
                        <p class="text-muted">Modifique los datos de la materia</p>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-modern p-4 p-lg-5">
                    <form action="{{ route('admin.asignaturas.update', $asignatura) }}" method="POST" id="materiaForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" name="nombre" id="nombre" class="form-control @error('nombre') is-invalid @enderror" 
                                           value="{{ old('nombre', $asignatura->nombre) }}" placeholder="Ej: Matemáticas, Español, Ciencias..." required autofocus>
                                </div>
                                @error('nombre')
