    ...
    <div class="col-12 mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <p class="text-muted">Registre una nueva clase con su video y material de apoyo</p>
            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="id_asignatura" id="id_asignatura" class="form-select form-select-lg @error('id_asignatura') is-invalid @enderror" required>
                                ...
                                @foreach($asignaturas as $asignatura)
                                    <option value="{{ $asignatura->id }}" {{ old('id_asignatura') == $asignatura->id ? 'selected' : '' }}>
                                        {{ $asignatura->nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="number" name="num_clase" id="num_clase" 
                                       ...
                                       value="{{ old('num_clase') }}" placeholder="Ej: 1, 2, 3..." min="1" required>
                            </div>
                            @error('num_clase')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" name="nombre_clase" id="nombre_clase" 
                                       ...
                                       value="{{ old('nombre_clase') }}" placeholder="Ej: Introducción a la Física" required>
                            </div>
                            @error('nombre_clase')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
