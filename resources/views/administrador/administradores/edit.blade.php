...
@section('title', 'Editar Administrador - SAINS')
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h1 class="display-5 fw-bold" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); -webkit-background-clip: text; background-clip: text; color: transparent;">
                    <i class="fas fa-user-edit me-3"></i>Editar Administrador
                </h1>
                <p class="text-muted">Modifique la información del administrador en el sistema</p>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card-modern p-4 p-lg-5">
            <form action="{{ route('admin.administradores.update', $user->id) }}" method="POST" id="editAdminForm" novalidate>
                @csrf
                @method('PUT')
                
                <!-- Stepper Indicator (Mismo que en crear) -->
                ...
                <div class="step-content" data-step="1">
                    <div class="d-flex align-items-center gap-3 mb-4 pb-2 border-bottom">
                        <div class="rounded-circle p-3" style="background: linear-gradient(135deg, rgba(102,126,234,0.1), rgba(118,75,162,0.1));">
                            <i class="fas fa-user-edit fa-2x" style="color: #4361ee;"></i>
                        </div>
                        <div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nombre" class="form-control form-control-lg @error('nombre') is-invalid @enderror" 
                                   value="{{ old('nombre', $admin->nombre) }}" placeholder="Ej: Juan" required>
                            @error('nombre')
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="apellido_paterno" class="form-control form-control-lg @error('apellido_paterno') is-invalid @enderror" 
                                   value="{{ old('apellido_paterno', $admin->apellido_paterno) }}" placeholder="Ej: Pérez" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="apellido_materno" class="form-control form-control-lg @error('apellido_materno') is-invalid @enderror" 
                                   value="{{ old('apellido_materno', $admin->apellido_materno) }}" placeholder="Ej: García">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" 
                                ...
                                value="{{ old('fecha_nacimiento', $admin->fecha_nacimiento ? \Carbon\Carbon::parse($admin->fecha_nacimiento)->format('Y-m-d') : '') }}" 
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="sexo" class="form-select form-select-lg @error('sexo') is-invalid @enderror">
                                ...
                                <option value="M" {{ old('sexo', $admin->sexo) == 'M' ? 'selected' : '' }}>Masculino</option>
                                <option value="F" {{ old('sexo', $admin->sexo) == 'F' ? 'selected' : '' }}>Femenino</option>
                                <option value="O" {{ old('sexo', $admin->sexo) == 'O' ? 'selected' : '' }}>Prefiero no decirlo</option>
                            </select>
                            @error('sexo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="tel" name="telefono" id="telefono" class="form-control form-control-lg @error('telefono') is-invalid @enderror" 
                                   value="{{ old('telefono', $admin->telefono) }}" placeholder="7771234567" maxlength="10" 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" 
                                       value="{{ old('email', $user->correo) }}" placeholder="admin@ejemplo.com" required>
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="confirmation-item">
                                    ...
                                    <span id="confirm_password_change">No</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function actualizarConfirmacion() {
        ...
        document.getElementById('confirm_password_change').textContent = password ? 'Sí' : 'No';
    }
